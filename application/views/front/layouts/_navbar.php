...
<nav class="navbar navbar-light navbar-expand-lg navbar-light bg-light fixed-top home">
   <div class="container">
      ...
      <img src="<?= base_url('images/brand/logohub.png') ?>" alt="">
      </a>
      ...
      <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
         ...
         <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
            <li>
            <a href="https://www.smknegeri1garut.sch.id/pplg/">
            ...
            &nbsp;
            <li>
            <a href="https://www.instagram.com/sija.smkn1garut/">
            ...
            &nbsp;
            <li>
            <a href="https://www.youtube.com/@SMKN1GARUTTV">
