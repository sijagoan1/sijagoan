...
<head>
  ...
  <title>Admin - SIJA UPDATE.com</title>
      ...
      <div id="content">
        ...
        <div class="container">
            ...
            <?= form_open_multipart($form_action) ?>
               ...
               <div class="form-group row">
                  <div class="col">
                     <label for="featured" class="col-form-label">Berita Unggulan</label>
                  ...
                  <div class="col">
                     <label for="thread" class="col-form-label">Berita Populer</label>
